...
class TABLENAME_schema(SQLAlchemyObjectType):
    class Meta:
        ...
        only_fields=['idTABLENAME']+list(attribute.keys())+list(read_only_attribute.keys())
...
all_TABLENAME = SQLAlchemyConnectionField(TABLENAME_schema,sort=graphene.String(),**attribute)

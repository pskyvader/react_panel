...
Revision ID: bff852faadf7
Revises: 0d47b0418da3
Create Date: 2020-01-10 17:04:18.841959
...
revision = 'bff852faadf7'
down_revision = '0d47b0418da3'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('seo_administrador', 'nombre',
               existing_type=mysql.CHAR(length=255),
               nullable=True)
    op.alter_column('seo_administrador', 'password',
               existing_type=mysql.CHAR(length=255),
               nullable=True)
    ...
    op.alter_column('seo_usuario', 'nombre',
               existing_type=mysql.CHAR(length=255),
               nullable=True)
    op.alter_column('seo_usuario', 'password',
               existing_type=mysql.CHAR(length=255),
               nullable=True)

...
from sqlalchemy import Column, DateTime, ForeignKey, Integer, String, func, Text, Boolean, JSON
...
class banner_model(Base):
    ...
    idbanner = Column(Integer, primary_key=True)
    tipo=Column(Integer)
...
class galeria_model(Base):
    ...
    idgaleria = Column(Integer, primary_key=True)
    tipo=Column(Integer)
    titulo=Column(String(255))
...
class igaccounts_model(Base):
    ...
    idigaccounts = Column(Integer, primary_key=True)
    ...
    has_anonymous_profile_picture=Column(Boolean)
...
class ighashtag_model(Base):
    ...
    idighashtag = Column(Integer, primary_key=True)
    hashtag=Column(String(255))
...
class igtotal_model(Base):
    ...
    idigtotal = Column(Integer, primary_key=True)
...
class igusuario_model(Base):
    ...
    idigusuario = Column(Integer, primary_key=True)
...
class logo_model(Base):
    ...
    idlogo = Column(Integer, primary_key=True)
    titulo=Column(String(255))
    foto=Column(JSON)
    orden=Column(Integer)
...
class mediopago_model(Base):
    ...
    idmediopago = Column(Integer, primary_key=True)
    titulo=Column(String(255))
    resumen=Column(Text)
...
class modulo_model(Base):
    ...
    orden=Column(Integer)
    estado=Column(Text)
    aside=Column(Boolean)
    hijos=Column(Boolean)
    
class moduloconfiguracion_model(Base):
    __tablename__ = "seo_moduloconfiguracion"
    idmoduloconfiguracion = Column(Integer, primary_key=True)
...
class pedido_model(Base):
    ...
    pedido_manual=Column(Boolean)
    
class pedidodireccion_model(Base):
    __tablename__ = "seo_pedidodireccion"
    idpedidodireccion = Column(Integer, primary_key=True)
...
class pedidoestado_model(Base):
    ...
    idpedidoestado = Column(Integer, primary_key=True)
    tipo=Column(Integer)
    titulo=Column(String(255))
    resumen=Column(Text)
...
class productocategoria_model(Base):
    ...
    idproductocategoria = Column(Integer, primary_key=True)
    idpadre=Column(Text)
    tipo=Column(Integer)
    titulo=Column(String(255))
    url=Column(String(255))
...
class seccioncategoria_model(Base):
    ...
    idseccioncategoria = Column(Integer, primary_key=True)
    idpadre=Column(Text)
    tipo=Column(Integer)
    titulo=Column(String(255))
    url=Column(String(255))
...
class seo_model(Base):
    ...
    idseo = Column(Integer, primary_key=True)
    titulo=Column(String(255))
    url=Column(String(255))
    subtitulo=Column(String(255))
    foto=Column(JSON)
    ...
    orden=Column(Integer)
    menu=Column(Boolean)
    submenu=Column(Boolean)
    estado=Column(Boolean)
    
class sitemap_model(Base):
    __tablename__ = "seo_sitemap"
    idsitemap = Column(Integer, primary_key=True)
...
class table_model(Base):
    ...
    idtable = Column(Integer, primary_key=True)
    tablename=Column(String(255))
    idname=Column(String(255))
    fields=Column(Text)
    truncate=Column(Boolean)
...
class usuariodireccion_model(Base):
    ...
    idusuariodireccion = Column(Integer, primary_key=True)
    idusuario=Column(Integer)
    tipo=Column(Integer)
    titulo=Column(String(255))
    nombre=Column(String(255))

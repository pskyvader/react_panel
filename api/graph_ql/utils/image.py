...
extensions = [ ".webp", ".bmp", ".ico", ".gif", ".jpeg", ".jpg", ".svg", ".xml", ".png", ".webm", ".mp4", ".zip", ".doc", ".docx", ".dotx", ".xls", ".xlsx", ".xltx", ".xlam", ".xlsb", ".ppt", ".pptx", ".potx", ".ppsx", ".sldx", ".pdf", ]
upload_dir = ""
upload_url = ""
recortes_cache={}
...
@staticmethod
def copy(
    original_file, name_final, folder, subfolder="", parent_final="", tag="thumb"
):
...
def upload(file, folder_upload="tmp", name_final=""):
    ...
    if respuesta["exito"]:
        ...
        if not respuesta["exito"]:
            ...
            respuesta["mensaje"] = (
                "Imagen " + file["name"] + " Subida correctamente"
            )
    return respuesta

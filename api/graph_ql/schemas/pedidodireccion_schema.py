...
class pedidodireccion_schema(SQLAlchemyObjectType):
    class Meta:
        ...
        only_fields=['idpedidodireccion']+list(attribute.keys())+list(read_only_attribute.keys())
...
class create_pedidodireccion(graphene.Mutation):
    ...
    pedidodireccion = graphene.Field(lambda: pedidodireccion_schema, description="pedidodireccion created by this mutation.")
...
class update_pedidodireccion(graphene.Mutation):
    ...
    pedidodireccion = graphene.Field(lambda: pedidodireccion_schema, description="pedidodireccion updated by this mutation.")

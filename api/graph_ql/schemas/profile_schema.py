...
all_profile = SQLAlchemyConnectionField(profile_schema,sort=graphene.String(),tipo=graphene.Int(),titulo=graphene.String(),orden=graphene.Int(),estado=graphene.Boolean())

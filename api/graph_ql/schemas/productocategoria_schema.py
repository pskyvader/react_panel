...
class productocategoria_schema(SQLAlchemyObjectType):
    ...
    def resolve_foto(parent,info, **kwargs):
        return resolve_all_image(parent,info,table_name='productocategoria',idparent=parent.idproductocategoria,field_name='foto',**kwargs)



def resolve_productocategoria(args, info, idproductocategoria, **kwargs):
    query = resolve(
        args, info, productocategoria_schema, productocategoria_model, idproductocategoria=idproductocategoria, **kwargs
    )
    return query.first()
...
class create_productocategoria(graphene.Mutation):
    ...
    productocategoria = graphene.Field(
        productocategoria_schema, description="productocategoria created by this mutation."
    )
...
class update_productocategoria(graphene.Mutation):
    ...
    productocategoria = graphene.Field(
        productocategoria_schema, description="productocategoria updated by this mutation."
    )

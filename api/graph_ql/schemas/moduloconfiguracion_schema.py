...
all_moduloconfiguracion = SQLAlchemyConnectionField(moduloconfiguracion_schema,sort=graphene.String(),icono=graphene.String(),module=graphene.String(),titulo=graphene.String(),sub=graphene.String(),padre=graphene.String(),mostrar=graphene.String(),detalle=graphene.String(),orden=graphene.Int(),estado=graphene.Boolean(),aside=graphene.Boolean(),tipos=graphene.Boolean())

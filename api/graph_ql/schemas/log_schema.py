...
all_log = SQLAlchemyConnectionField(log_schema,sort=graphene.String(),administrador=graphene.String(),tabla=graphene.String(),accion=graphene.String(),fecha=graphene.types.datetime.DateTime())

...
class modulo_schema(SQLAlchemyObjectType):
    class Meta:
        ...
        only_fields=['idmodulo']+list(attribute.keys())+list(read_only_attribute.keys())
...
all_modulo = SQLAlchemyConnectionField(modulo_schema,sort=graphene.String(),**attribute)

...
all_pedidoproducto = SQLAlchemyConnectionField(pedidoproducto_schema,sort=graphene.String(),idpedido=graphene.Int(),idpedidodireccion=graphene.Int(),idproducto=graphene.Int(),titulo=graphene.String(),mensaje=graphene.String(),idproductoatributo=graphene.Int(),titulo_atributo=graphene.String(),precio=graphene.Int(),cantidad=graphene.Int(),total=graphene.Int())
